...
class StoreAssetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'asset_tag' => 'nullable|string|max:255|unique:asset,asset_tag', // Optional but must be unique
            'name' => 'required|string|max:255|unique:asset,name', // Required, unique, max 255 characters
            'serial_number' => 'required|string|max:255|unique:asset,serial_number', // Required, unique, max 255 characters
